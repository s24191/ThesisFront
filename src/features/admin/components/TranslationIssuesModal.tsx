...
import type {TranslationReviewItem, TranslationReviewOccurrence} from "@/features/admin/types";
import {adminScrapingApi} from "@/features/admin/api/adminScrapingApi.ts";
